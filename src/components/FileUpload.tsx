...
type FileUploadProps = {
  ...
  linkedId: string;
  onUpload?: (attachment: { id: string; file_path: string; mime: string }) => void;
  maxFiles?: number;
    ...
    <div className="space-y-3">
      ...
      {files.length > 0 && (
        <div className="space-y-2">
          ...
          {files.map((file) => (
            <div key={file.id} className="flex items-center justify-between p-2 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
