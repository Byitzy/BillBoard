      ...
      <div className="space-y-2">
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            { value: 'feature', label: 'Feature Request', icon: Plus, color: 'text-blue-600' },
            { value: 'idea', label: 'General Idea', icon: Lightbulb, color: 'text-yellow-600' }
          ].map((opt) => {
            const Icon = opt.icon;
            return (
              <button
              ...
              >
                <div className="flex flex-col items-center gap-1">
                  <Icon className={`w-5 h-5 ${type === opt.value ? 'text-blue-600' : opt.color}`} />
