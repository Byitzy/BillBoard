        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {monthlyTrend !== 0 && (
                <p
                  className={`text-xs flex items-center gap-1 ${monthlyTrend > 0 ? 'text-red-600' : 'text-green-600'}`}
                >
                  {monthlyTrend > 0 ? (
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">
                ${stats.averageMonthlySpend.toFixed(2)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">
                {stats.avgBillsPerMonth.toFixed(0)}
              </p>
            </div>
          </div>
        </div>
