...
export default function TwoWeeksReport() {
  ...
  useEffect(() => {
    async function loadTwoWeeksReport() {
      try {
        setLoading(true);
        ...
        setError(err.message || 'Failed to load two weeks report');
      } finally {
        setLoading(false);
      }
    }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold">Report · Next 2 Weeks</h1>
      ...
      <div className="rounded-2xl border border-neutral-200 p-4 card-surface dark:border-neutral-800">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold">Bills Due in Next 2 Weeks</h2>
        ...
        {loading ? (
          ...
          <div className="text-sm text-neutral-500">No bills due in the next 2 weeks.</div>
        ) : (
